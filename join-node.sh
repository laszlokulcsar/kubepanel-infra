...
main() {
    ...
    echo -e "${BLUE}║${NC}    Run this on your main node to get the join command:"
    echo -e "${BLUE}║${NC}    ${GREEN}microk8s add-node --token-ttl 3600${NC}"
    echo -e "${BLUE}║${NC}"
    echo -e "${BLUE}║${NC} ${YELLOW}2. Run the join command on this node:${NC}"
    echo -e "${BLUE}║${NC}    Copy and paste the join command here, it will look like:"
    echo -e "${BLUE}║${NC}    ${GREEN}microk8s join <IP>:25000/<TOKEN>${NC}"
    echo -e "${BLUE}║${NC}"
    echo -e "${BLUE}║${NC} ${YELLOW}3. Verify the node joined successfully:${NC}"
    echo -e "${BLUE}║${NC}    Check on the main node with:"
    echo -e "${BLUE}║${NC}    ${GREEN}microk8s kubectl get nodes${NC}"
    echo -e "${BLUE}╚════════════════════════════════════════════════════════════════════╝${NC}"
